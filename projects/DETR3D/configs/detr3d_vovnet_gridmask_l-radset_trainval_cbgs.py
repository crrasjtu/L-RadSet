_base_ = ['./detr3d_r101_gridmask_m2dset_cbgs.py']
...
train_dataloader = dict(
    dataset=dict(
        type='CBGSDataset',
        dataset=dict(ann_file='m2dset_infos_trainval.pkl')))

test_dataloader = dict(
    dataset=dict(
        data_root='data/m2dset', ann_file='m2dset_infos_test.pkl'))

test_evaluator = dict(
    type='M2DSetMetric',
    data_root='data/m2dset',
    ann_file='data/m2dset/m2dset_infos_test.pkl',
