...
def parse_args():
    ...
    parser.add_argument('--config', default='work_dirs/deformfusion_lidar_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d/deformfusion_lidar_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d.py', help='test config file path')
    parser.add_argument('--checkpoint', default='work_dirs/deformfusion_lidar_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d/epoch_1.pth', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
    ...
    parser.add_argument(
        '--show-dir',
        # default='work_dirs/petr_m2dset/show/',
