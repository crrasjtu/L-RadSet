...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'radset_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
model = dict(
    ...
    voxel_encoder=dict(type='HardSimpleVFE', num_features=6),
    middle_encoder=dict(
        type='SparseEncoder',
        in_channels=6,
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            type='Anchor3DRangeGenerator',
             ranges=[
		        [0, -40, -1.2082, 70.4, 40, -1.2082],
                [0, -40, -0.2006, 70.4, 40, -0.2006],
                [0, -40, -0.4842, 70.4, 40, -0.4842],
		        [0, -40, -1.2745, 70.4, 40, -1.2745],
		        [0, -40, -1.5867, 70.4, 40, -1.5867],
		        [0, -40, -1.2295, 70.4, 40, -1.2295],
		        [0, -40, -1.2082, 70.4, 40, -1.2082],
		        [0, -40, -1.4977, 70.4, 40, -1.4977],
		        [0, -40, -1.5552, 70.4, 40, -1.5552]],
            sizes=[
		        [4.41, 1.93, 1.63], # car
		        [9.82, 2.83, 3.14], # bus
...
# resume = True
# resume_from = 'work_dirs/pv_rcnn_8xb2-80e_radset-3d/epoch_16.pth'