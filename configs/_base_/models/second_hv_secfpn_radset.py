...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[
		[0, -40.2, -1.2082, 70.2, 40.2, -1.2082],
                [0, -40.2, -0.2006, 70.2, 40.2, -0.2006],
                [0, -40.2, -0.4842, 70.2, 40.2, -0.4842],
		[0, -40.2, -1.2745, 70.2, 40.2, -1.2745],
		[0, -40.2, -1.5867, 70.2, 40.2, -1.5867],
		[0, -40.2, -1.2295, 70.2, 40.2, -1.2295],
		[0, -40.2, -1.2082, 70.2, 40.2, -1.2082],
		[0, -40.2, -1.4977, 70.2, 40.2, -1.4977],
		[0, -40.2, -1.5552, 70.2, 40.2, -1.5552]
            ],
            sizes=[
		[4.41, 1.93, 1.63], # car
		[9.82, 2.83, 3.14], # bus
